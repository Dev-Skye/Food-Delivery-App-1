...
import {
    View,
    Text, TouchableOpacity, Image, FlatList, TextInput
} from 'react-native';
import {useState} from "react";
import {FONTS, SIZES, COLORS, icons, dummyData} from "../../constants";
import {HorinzontalFoodCard, VerticalFoodCard} from "../../components";
...
const Home = () => {
    ...
    function handleChangeCategory(categoryId, menuTypeId){
        ...
        let selectedRecommend = dummyData.menu.find(a => a.name == "Recommended")
         ...
         //find the menu based on the menu id
                ...
                renderItem={({item, index}) => {
                    return(
                        <HorinzontalFoodCard
                            ...
                            item={item}
                            onPress={() => console.log("HorinzontalFoodCard")}
                        >
